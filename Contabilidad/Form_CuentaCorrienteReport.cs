...
{
    public partial class Form_CuentaCorrienteReport : Form
    {
        ...
        public Int32 a3;
        public Form_CuentaCorrienteReport()
        {
            InitializeComponent();
        }

        private void Form_CuentaCorrienteReport_Load(object sender, EventArgs e)
        {
