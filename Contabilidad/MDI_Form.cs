...
{
    public partial class MDI_Form : Telerik.WinControls.UI.RadForm
    {
     ...
     //private void B_salir_Click(object sender, EventArgs e)
        //{
        //    if (MessageBox.Show("Desea Salir de la Aplicacion?", "Administrador del Sistema", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
        //    {
        //        Close();
        //    }
        //}